/****************************************************************************
** Meta object code from reading C++ file 'qt_PlotWindow.h'
**
...
#error "The header file 'qt_PlotWindow.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_PlotWindow[] = {
    "PlotWindow\0\0plotCurves()\0plotHistogram()\0"
    "interactive()\0"
};
...
void PlotWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->plotCurves(); break;
        case 1: _t->plotHistogram(); break;
        case 2: _t->interactive(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
