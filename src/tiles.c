...
void get_tiles0(int tiles[], int num_tilings, double variables[],
                int num_variables, int memory_size) {
    get_tiles1(tiles, num_tilings, variables, num_variables, memory_size,-1);
}
void get_tiles1(int tiles[], int num_tilings, double variables[],
                int num_variables, int memory_size, int hash1) {

    get_tiles2(tiles, num_tilings, variables, num_variables, memory_size,hash1,-1);
}
void get_tiles2(int tiles[], int num_tilings, double variables[],
                int num_variables, int memory_size, int hash1, int hash2) {
    get_tiles3(tiles, num_tilings, variables, num_variables, memory_size,hash1,hash2,-1);
